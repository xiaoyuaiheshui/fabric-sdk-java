...
public class SampleStore {
 ...
 /*   public void storeClientPEMTLSKey(FabricOrg sampleOrg, String key) {

        setValue("clientPEMTLSKey." + sampleOrg.getName(), key);

    }

    public String getClientPEMTLSKey(FabricOrg sampleOrg) {

        return getValue("clientPEMTLSKey." + sampleOrg.getName());

    }

    public void storeClientPEMTLCertificate(FabricOrg sampleOrg, String certificate) {

        setValue("clientPEMTLSCertificate." + sampleOrg.getName(), certificate);

    }

    public String getClientPEMTLSCertificate(FabricOrg sampleOrg) {
